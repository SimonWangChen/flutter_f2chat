...
import 'package:flutter_f2chat/global/funs.dart';
...
//    _unameController.text = Global.profile.lastLogin;
  ...
  void _onLogin() async {
    ...
    if ((_formKey.currentState as FormState).validate()) {
      ...
      User user;
      try {
        User user = await ProClassmates(context).login(queryParameters: {
...
//          print(GmLocalizations.of(context).userNameOrPasswordWrong);
//        }
      } finally {
        // 隐藏loading框
